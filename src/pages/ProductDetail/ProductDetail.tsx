...
export default function ProductDetail() {
  ...
  const queryConfig = useMemo<ProductListConfig>(() => {
    return product ? { limit: '20', page: '1', category: product.category._id } : { limit: '20', page: '1' }
  }, [product])
          ...
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <button className='fkex ml-4 h-12 min-w-[5rem] items-center justify-center rounded-sm bg-orange-600 px-5 capitalize text-white shadow-sm outline-none hover:bg-orange-600/90'>
                  Mua ngay
                </button>
              </div>
            </div>
